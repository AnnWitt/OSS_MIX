...
'--DMP START
For lp = 4 To 37 'v20210929 -- do 37 a nie 38 bo tu zaczyna sie od VC1VC2
'--DMP STOP
...
'---DMP START
' ---> czy potrzbne Union(BIL.Cells(R + 1, "CM"), BIL.Cells(R + 1, "CY")).Borders(xlEdgeRight).Weight = xlThin 'DMP
Range(BIL.Cells(R + 1, 2), BIL.Cells(R + 1, 106)).NumberFormat = "0" 'DMP 'v20210929
'---DMP STOP
