...
Dim o As Integer, v As Integer, new_row As Boolean, x1 As Integer, x2 As Integer, x3 As Integer, x4 As Integer, lp As Integer, arkusz As String
...
If ALL.Cells(v, "A") <> ALL.Cells(v - 1, "A") Then
        ...
        End If
Else
    If ALL.Cells(v, "B") <> ALL.Cells(v - 1, "B") Then
        If (ALL.Cells(v - 1, "A") <> ow.Cells(o - 1, "B")) Or (ALL.Cells(v - 1, "B") <> ow.Cells(o - 1, "C")) Then
        new_row = True
        Else
        End If
...
If new_row = True Then
    ow.Cells(o, "B") = ALL.Cells(v - 1, "A")
    ow.Cells(o, "C") = ALL.Cells(v - 1, "B")
    ...
    '---DMP START
    Range(ow.Cells(o, "A"), ow.Cells(o, "EB")).Font.Size = 9
    Range(ow.Cells(o, "A"), ow.Cells(o, "EB")).Font.Name = Calibri
    Range(ow.Cells(o, "A"), ow.Cells(o, "EB")).NumberFormat = "general"
    Range(ow.Cells(o, "A"), ow.Cells(o, "EB")).HorizontalAlignment = xlCenter
    Range(ow.Cells(o, "A"), ow.Cells(o, "EB")).VerticalAlignment = xlCenter
    '---DMP STOP
    ...
    ow.Cells(o, x1) = WorksheetFunction.SumIfs(Range(temp.Cells(2, "I"), temp.Cells(v, "I")), Range(temp.Cells(2, "A"), temp.Cells(v, "A")), ow.Cells(o, "B"), Range(temp.Cells(2, "B"), temp.Cells(v, "B")), ow.Cells(o, "C"))
    
    ow.Cells(o, x2) = ow.Cells(o, x1) / WorksheetFunction.VLookup(ow.Cells(1, x1), Range(sz.Cells(3, "A"), sz.Cells(34, "B")), 2, 0) 'DMP |+ dopisz w konfiguracji
    ...
    'osobny dla VC2
     ...
     ow.Cells(o, 5) = WorksheetFunction.SumIfs(Range(ALL.Cells(2, "I"), ALL.Cells(v, "I")), Range(ALL.Cells(2, "A"), ALL.Cells(v, "A")), ow.Cells(o, "B"), Range(ALL.Cells(2, "B"), ALL.Cells(v, "B")), ow.Cells(o, "C"))
    
    ow.Cells(o, 6) = ow.Cells(o, 5) / WorksheetFunction.VLookup(ow.Cells(1, 5), Range(sz.Cells(3, "A"), sz.Cells(34, "B")), 2, 0)
