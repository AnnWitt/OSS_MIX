...
"'Assigned Group*+' = " & x & "MIESZKO_VENDOR" & x & " or " & "'Assigned Group*+' = " & x & "APLIKACJE_ATRIUM" & x & " or " & "'Assigned Group*+' = " & x & "DOSTAWCA_ATRIUM" & x & ")" & " AND 'Status*' >= " & x & "Resolved" & x & " AND 'Last Resolved Date' >" & x & Worksheets("GO").Cells(4, "L") & " 00:00:00" & x & " AND 'Last Resolved Date' < " & x & Worksheets("GO").Cells(5, "L") & " 23:59:59" & x
Worksheets("CSV").Cells(5, "N") = "('Assigned Group*+' LIKE " & x & "VC_OSS_FIXED_%" & x & " or " & "'Assigned Group*+' LIKE " & x & "VC_TP_OSS_%" & x & " or " & _
"'Assigned Group*+' = " & x & "MIESZKO_VENDOR" & x & " or " & "'Assigned Group*+' = " & x & "APLIKACJE_ATRIUM" & x & " or " & "'Assigned Group*+' = " & x & "DOSTAWCA_ATRIUM" & x & ")" & " AND 'Submit Date' >" & x & Worksheets("GO").Cells(4, "L") & " 00:00:00" & x & " AND 'Submit Date' < " & x & Worksheets("GO").Cells(5, "L") & " 23:59:59" & x
Worksheets("CSV").Cells(6, "N") = "('Assigned Group*+' LIKE " & x & "VC_OSS_FIXED_%" & x & " or " & "'Assigned Group*+' LIKE " & x & "VC_TP_OSS_%" & x & " or " & _
"'Assigned Group*+' = " & x & "MIESZKO_VENDOR" & x & " or " & "'Assigned Group*+' = " & x & "APLIKACJE_ATRIUM" & x & " or " & "'Assigned Group*+' = " & x & "DOSTAWCA_ATRIUM" & x & ")" & " AND ('Resolve to'<'Last Resolved Date'  AND 'Status*' >= " & x & "Resolved" & x & ") AND ('Last Resolved Date' >" & x & Worksheets("GO").Cells(4, "L") & " 00:00:00" & x & " AND 'Last Resolved Date' < " & x & Worksheets("GO").Cells(5, "L") & " 23:59:59" & x & ")"
