...
+ Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 1)), (csv.Cells(max, 1))), "DOSTAWCA_ATRIUM") 'V58
...
Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 3)), (csv.Cells(max, 3))), "DOSTAWCA_ATRIUM") 'V58
...
+ Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 5)), (csv.Cells(max, 5))), "DOSTAWCA_ATRIUM") 'V58
...
+ Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 7)), (csv.Cells(max, 7))), "DOSTAWCA_ATRIUM") 'V58
...
+ Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 9)), (csv.Cells(max, 9))), "DOSTAWCA_ATRIUM") 'V58

 
For lp = 4 To 36 ' DMP 'v20210929 V58
...
'--- atrium 35 - ³atka dopóki nie ustabilizujemy grup, potem to odwrócimy


'If lp = 35 Then
'SRC.Cells(lp, 2) = SRC.Cells(lp, 2) + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 1)), (csv.Cells(max, 1))), "DOSTAWCA_ATRIUM")
'SRC.Cells(lp, 3) = SRC.Cells(lp, 3) + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 3)), (csv.Cells(max, 3))), "DOSTAWCA_ATRIUM")
'SRC.Cells(lp, 4) = SRC.Cells(lp, 4) + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 5)), (csv.Cells(max, 5))), "DOSTAWCA_ATRIUM")
'SRC.Cells(lp, 5) = SRC.Cells(lp, 5) + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 7)), (csv.Cells(max, 7))), "DOSTAWCA_ATRIUM")
'SRC.Cells(lp, 6) = SRC.Cells(lp, 6) + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 9)), (csv.Cells(max, 9))), "DOSTAWCA_ATRIUM")
'Else
'End If
