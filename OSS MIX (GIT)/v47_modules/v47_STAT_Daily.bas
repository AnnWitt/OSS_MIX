...
'--DMP START
Daily.Cells(3, 3) = SRC.Cells(3, 2) - SRC.Cells(36, 2) 'v20210929
Daily.Cells(3, 4) = SRC.Cells(3, 3) - SRC.Cells(36, 3) 'v20210929
Daily.Cells(3, 5) = SRC.Cells(3, 4) - SRC.Cells(36, 4) 'v20210929
Daily.Cells(3, 6) = SRC.Cells(3, 5) - SRC.Cells(36, 5) 'v20210929
Daily.Cells(3, 7) = SRC.Cells(3, 6) - SRC.Cells(36, 6) 'v20210929

    For rd = 4 To 35 'v20210929 ostatatni z normalnym produktem
