...
v = WorksheetFunction.CountA(ALL.Columns(1)) 'ostatni wypełniony wiersz
same_month = False
new_row = False
...
If (new_row = True Or same_month = True) Then
    ...
    'niby dla idf mogloby byc v - 1626 ale to byc trzeba wyjsc poza pętle, nic mu nie będzie jak posumuje tez po pustym zakresie
