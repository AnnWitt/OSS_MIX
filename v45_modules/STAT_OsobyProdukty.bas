...
Union(Range(VT.Cells(cv, "A"), VT.Cells(cv, "J")), Range(VT.Cells(3, "J"), VT.Cells(cv, "J")), Range(VT.Cells(3, "I"), VT.Cells(cv, "I")), Range(VT.Cells(3, "B"), VT.Cells(cv, "B"))).Font.Bold = True

Range(VT.Cells(3, "D"), VT.Cells(cv, "E")).Interior.Color = RGB(234, 234, 234)

Union(Range(VT.Cells(cv, "A"), VT.Cells(cv, "J")), Range(VT.Cells(3, "J"), VT.Cells(cv, "J")), Range(VT.Cells(3, "B"), VT.Cells(cv, "C"))).Interior.Color = RGB(192, 0, 0)
Union(Range(VT.Cells(cv, "A"), VT.Cells(cv, "J")), Range(VT.Cells(3, "J"), VT.Cells(cv, "J")), Range(VT.Cells(3, "B"), VT.Cells(cv, "C"))).Font.ColorIndex = 2
...
VT.Cells(cv, "M") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned", PBI.Columns("J"), VT.Cells(2, "M")) + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
VT.Cells(cv, "N") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned", PBI.Columns("J"), VT.Cells(2, "N")) + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
VT.Cells(cv, "O") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned", PBI.Columns("J"), VT.Cells(2, "O")) + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
VT.Cells(cv, "P") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned", PBI.Columns("J"), VT.Cells(2, "P")) + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
VT.Cells(cv, "Q") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned", PBI.Columns("J"), VT.Cells(2, "Q")) + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
VT.Cells(cv, "R") = Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Assigned") + Application.WorksheetFunction.CountIfs(PBI.Columns("C"), VT.Cells(cv, 12), PBI.Columns("F"), "Draft") ' bo foch na funkcje :)
...
Union(Range(VT.Cells(1, "A"), VT.Cells(2, "J")), Range(VT.Cells(x1, "A"), VT.Cells(x1, "J")), Range(VT.Cells(1, "A"), VT.Cells(x1, "A")), Range(VT.Cells(3, "J"), VT.Cells(x1, "J")), Range(VT.Cells(1, "H"), VT.Cells(x1, "H")), Range(VT.Cells(2, "E"), VT.Cells(x1, "E"))).Borders(xlEdgeRight).Weight = xlMedium
Union(Range(VT.Cells(1, "A"), VT.Cells(2, "J")), Range(VT.Cells(x1, "A"), VT.Cells(x1, "J")), Range(VT.Cells(3, "A"), VT.Cells(x1, "A")), Range(VT.Cells(1, "D"), VT.Cells(x1, "D")), Range(VT.Cells(1, "J"), VT.Cells(x1, "J"))).Borders(xlEdgeLeft).Weight = xlMedium
Range(VT.Cells(1, "D"), VT.Cells(x1, "D")).Borders(xlEdgeLeft).Weight = xlMedium

Union(Range(VT.Cells(2, "L"), VT.Cells(1, "S")), Range(VT.Cells(x2, "L"), VT.Cells(x2, "S")), Range(VT.Cells(3, "R"), VT.Cells(x2, "R"))).Borders(xlEdgeBottom).Weight = xlMedium
Union(Range(VT.Cells(1, "L"), VT.Cells(1, "S")), Range(VT.Cells(x2, "L"), VT.Cells(x2, "S")), Range(VT.Cells(3, "R"), VT.Cells(x2, "R"))).Borders(xlEdgeTop).Weight = xlMedium
Union(Range(VT.Cells(1, "L"), VT.Cells(2, "S")), Range(VT.Cells(x2, "L"), VT.Cells(x2, "S")), Range(VT.Cells(3, "L"), VT.Cells(x2, "L")), Range(VT.Cells(3, "S"), VT.Cells(x2, "S")), Range(VT.Cells(3, "Q"), VT.Cells(x2, "Q"))).Borders(xlEdgeRight).Weight = xlMedium
Union(Range(VT.Cells(1, "L"), VT.Cells(2, "S")), Range(VT.Cells(x2, "L"), VT.Cells(x2, "S")), Range(VT.Cells(3, "L"), VT.Cells(x2, "L")), Range(VT.Cells(3, "S"), VT.Cells(x2, "S"))).Borders(xlEdgeLeft).Weight = xlMedium
