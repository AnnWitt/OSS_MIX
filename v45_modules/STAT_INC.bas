...
'--DMP START
Range(SRC.Cells(3, 2), SRC.Cells(36, 6)).ClearContents 'DMP
'--DMP STOP
...
SRC.Cells(3, 2) = Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 1)), (csv.Cells(max, 1))), "VC_OSS_FIXED_*") + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 1)), (csv.Cells(max, 1))), "MIESZKO VENDOR")
SRC.Cells(3, 3) = Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 3)), (csv.Cells(max, 3))), "VC_OSS_FIXED_*") + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 3)), (csv.Cells(max, 3))), "MIESZKO VENDOR")
SRC.Cells(3, 4) = Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 5)), (csv.Cells(max, 5))), "VC_OSS_FIXED_*") + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 5)), (csv.Cells(max, 5))), "MIESZKO VENDOR")
SRC.Cells(3, 5) = Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 7)), (csv.Cells(max, 7))), "VC_OSS_FIXED_*") + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 7)), (csv.Cells(max, 7))), "MIESZKO VENDOR")
SRC.Cells(3, 6) = Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 9)), (csv.Cells(max, 9))), "VC_OSS_FIXED_*") + Application.WorksheetFunction.CountIf(Range((csv.Cells(2, 9)), (csv.Cells(max, 9))), "MIESZKO VENDOR")
...
'--DMP START
rmod = sz.Cells(37, "O")
ALL.Cells(R + rmod, 6) = SRC.Cells(3, 2) - SRC.Cells(35, 2)
ALL.Cells(R + rmod, 7) = SRC.Cells(3, 3) - SRC.Cells(35, 3)
ALL.Cells(R + rmod - 1, 8) = SRC.Cells(3, 4) - SRC.Cells(35, 4)
ALL.Cells(R + rmod - 1, 9) = SRC.Cells(3, 5) - SRC.Cells(35, 5)
ALL.Cells(R + rmod - 1, 10) = SRC.Cells(3, 6) - SRC.Cells(35, 6)
'--DMP STOP
